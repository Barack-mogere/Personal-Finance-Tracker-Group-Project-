...
_Generated: 2026-09-12T16:11:43.196Z_
...
Workspace `mcp.json` _(folder: Personal-Finance-Tracker-Group-Project-)_

- **\\wsl.localhost\Ubuntu\home\beatrice\Personal-Finance-Tracker-Group-Project-\.vscode\mcp.json** — _File missing_
